...
| WB  | 20201113 |  Aanpak: Beschreven aanpak klopt niet. | Nee | Watv moet het worden?|
| WB  | 20201113 |  Status van dit document: Wie is ‘de werkgroep’?  | Ja | is aangepast (en standaard Respec)|
| WB  | 20201113 |  1.2 Leeswijzer: Link naar Inrichting van de Objectenregistratie werkt niet  | Ja | Link werkt nu wel |
| WB  | 20201113 |  1.2 Leeswijzer: Link naar Componenten werkt niet  | Ja | Het hoofdfstuk heet 'Uitwerking' tekst en link aangepast |
| WB  | 20201113 |  1.3 Het proces: Verwijzing naar hoofdlijnenrapport is niet goed.  | Nee| Link werkt wel, of verwijst de link naar het verkeerde rapport?|
...
| WB  | 20201113 |  3. ICT-inrichtingsprincipes: “De Beleidsvisie Samenhangende Objectenregistratie beschrijft de doelstellingen en beleidscontouren VOOR DE OBJECTENREGISTRATIE” | Ja | aangepast |
